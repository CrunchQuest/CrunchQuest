...
import com.crunchquest.shared.R.id
...
import com.crunchquest.android.presentation.ui.PaymentActivity
import com.crunchquest.android.domain.utility.handlers.ServiceRequestHandler
import com.crunchquest.android.presentation.ui.buyer.buyer_activities.BottomFragmentAssist
...
class RequestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val arrayList = resources.getStringArray(R.array.category)
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(arg0: AdapterView<*>?, arg1: View,
                ...
                val apiService = ApiConfig.retrofitDbApi.create(ApiService::class.java)
    ...
    private fun modeOfPayment() {
        ...
        ArrayAdapter.createFromResource(this, R.array.paymentMethod, android.R.layout.simple_spinner_item)
            .also { adapter ->
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
                spinnerPayment.adapter = adapter
            }
        val arrayList = resources.getStringArray(R.array.paymentMethod)
...
//        //Check the price
    ...
    private fun createRequest(location: Location?) {
        ...
        userRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val serviceRequest = com.crunchquest.android.domain.model.ServiceRequest(
                    uid = requestUserUid,
                        ...
                        .addOnCompleteListener { task ->
                            if (task.isSuccessful) {
                                ...
                                if(selectedPaymentMode == "Mobile Payments") {
                                    ...
                                    val orderUserCombo =
                                        com.crunchquest.android.domain.model.payment.OrderUserCombo(
                                            serviceRequest,
                                            user!!
                                        )
    ...
    private fun setCategory(category: String) {
        var arrayList = resources.getStringArray(array.category)
