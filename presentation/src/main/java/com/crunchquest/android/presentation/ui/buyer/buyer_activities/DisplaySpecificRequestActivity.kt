...
package com.crunchquest.android.presentation.ui.buyer.buyer_activities
...
//    private lateinit var userReviewButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val serviceExtra = intent.getParcelableExtra<com.crunchquest.android.domain.model.ServiceRequest>("ServiceRequest")
        if (serviceExtra != null) {
            service = serviceExtra ?: com.crunchquest.android.domain.model.ServiceRequest()
...
//    }
    ...
    private fun showUserReviewRatingAndJobsFinished() {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                val userData = snapshot.getValue(com.crunchquest.android.domain.model.UserSellerInfo::class.java)!!
                if (userData.count == 0) {
    ...
    private fun fetchService() {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                ...
                if (service != null) {
                    serviceTitleTextView.text = "${service.serviceName?.toUpperCase()}"
                    serviceDescriptionTextView.text = "${service.serviceDescription}"
    ...
    private fun fetchUserData() {
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                ...
                Picasso.get().load(user!!.profilePicture).into(profileImageView)
                nameTextView.text = "${user.firstName.toString()} ${user.lastName.toString()}"
            }
