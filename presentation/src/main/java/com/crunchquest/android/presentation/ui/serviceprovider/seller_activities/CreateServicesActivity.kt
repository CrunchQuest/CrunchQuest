...
class CreateServicesActivity : AppCompatActivity() {
        ...
        dialogBuilder.setMessage("Do you want to create the service?")
                ...
                .setPositiveButton("Proceed") { _, _ ->
                    ...
                    val service = uid?.let {
                        Service(
                            serviceId = it,
                            serviceName = titleEditText.text.toString(),
                            serviceDescription = descriptionEditText.text.toString(),
                    ...
                    serviceRef.child(service?.serviceId!!).setValue(service)
                            .addOnSuccessListener {
    ...
    private fun update() {
        ...
        dialogBuilder.setMessage("Do you want to update the service?")
                ...
                .setPositiveButton("Update") { _, _ ->
                    val currentUser = FirebaseAuth.getInstance().currentUser!!.uid
                    val servicesRef = FirebaseDatabase.getInstance().getReference("/services/$currentUser/${SellerServicesFragment.serviceGettingEdited!!.serviceId}")
                    ...
                    if (arrayListImagesToBeUploaded.isNotEmpty()) {
                        deleteImagesFromFirebase(SellerServicesFragment.serviceGettingEdited!!.serviceId!!)
                        //upload again
                        uploadImages(SellerServicesFragment.serviceGettingEdited!!.serviceId!!)
                        finish()
                    } else {
                        finish()
                    }
    ...
    private fun checkFirst() {
        if (SellerServicesFragment.serviceGettingEdited == null) {
            ...
            titleEditText.setText(SellerServicesFragment.serviceGettingEdited!!.serviceName)
            descriptionEditText.setText(SellerServicesFragment.serviceGettingEdited!!.serviceDescription)
