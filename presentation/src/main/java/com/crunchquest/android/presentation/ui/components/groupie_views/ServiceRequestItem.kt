...
class ServiceRequestItem(val serviceRequest: com.crunchquest.android.domain.model.ServiceRequest, val distance: Double, val similarity: Int, val c: Context) : Item<ViewHolder>() {
