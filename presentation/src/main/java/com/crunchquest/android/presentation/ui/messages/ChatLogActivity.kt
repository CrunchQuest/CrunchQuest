        ...
        ref.addChildEventListener(object : ChildEventListener {
            override fun onChildAdded(snapshot: DataSnapshot, previousChildName: String?) {
                ...
                if (message != null && !message.content.isNullOrEmpty()) {
                    Log.d(TAG, "Message data: ${message.content}, from: ${message.senderId}, timestamp: ${message.timestamp}")
                    if (message.senderId == FirebaseAuth.getInstance().currentUser!!.uid) {
//                        val currentUser = BuyerActivity.currentUser
//                        if (currentUser != null) {
//                            adapter.add(ChatToItem(message.content!!, currentUser, message.timestamp!!))
//                        } else {
//                            adapter.add(ChatFromItem(message.content!!, toUser!!, message.timestamp!!))
//                        }
                    } else {
