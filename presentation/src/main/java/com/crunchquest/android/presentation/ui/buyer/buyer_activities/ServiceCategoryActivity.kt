...
import com.crunchquest.android.presentation.ui.components.groupie_views.ServiceItem
import com.crunchquest.android.presentation.ui.request.RequestActivity
                    ...
                    if (user.key != currentUser) {
                        user.children.forEach { serviceListed ->
                            ...
                            if (service!!.category == category && service.status == "ACTIVE") {
                                serviceProviderArrayList.add(service.serviceId!!)
                            }
