...
import com.crunchquest.android.domain.model.UserSellerInfo
import com.crunchquest.android.domain.model.UserSkills
import com.crunchquest.android.presentation.ui.general.DisplayReviewsActivity
import com.crunchquest.android.domain.utility.handlers.UserSellerInfoHandler
import com.crunchquest.android.domain.utility.handlers.UserSkillsHandler
...
class AboutMeAsSellerActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    var userSellerInfoArrayList: ArrayList<com.crunchquest.android.domain.model.UserSellerInfo> = ArrayList()
    var userSkillsArrayList: ArrayList<com.crunchquest.android.domain.model.UserSkills> = ArrayList()
    lateinit var userSkillsArrayAddapter: ArrayAdapter<com.crunchquest.android.domain.model.UserSkills>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val educationalStatusArrayList = resources.getStringArray(R.array.educationStatus)
        educationStatusSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
        ...
        //Toolbar
        toolBar.title = "Seller Informations"
    ...
    private fun addSkill() {
        if (addSkillEditText.text.toString().isEmpty()) {
            ...
            val skill = com.crunchquest.android.domain.model.UserSkills(
    ...
    override fun onStart() {
        ...
        userSkillsHandler.userSkillsRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                ...
                p0.children.forEach {
                    val userSkills = it.getValue(com.crunchquest.android.domain.model.UserSkills::class.java)
    ...
    private fun fetchSellerInfo() {
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                val userData = p0.getValue(com.crunchquest.android.domain.model.UserSellerInfo::class.java)!!
                ...
                if (userData.educationalAttainment == educationalStatusArrayList[0]) {
                    ...
                    educationStatusSpinner.setSelection(5)
                }
